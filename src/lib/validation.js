...
export const isValidChamp = (c) =>
  c === null ||
  (typeof c === "object" && !Array.isArray(c) && typeof c.id === "string" && c.id.length <= 64);

export const isValidGame = (g) =>
  g &&
  typeof g === "object" &&
  !Array.isArray(g) &&
  Array.isArray(g.blueBan) &&
  g.blueBan.length === 5 &&
  g.blueBan.every(isValidChamp) &&
  Array.isArray(g.redBan) &&
  g.redBan.length === 5 &&
  g.redBan.every(isValidChamp) &&
  Array.isArray(g.blue) &&
  g.blue.length === 5 &&
  g.blue.every(isValidChamp) &&
  Array.isArray(g.red) &&
  g.red.length === 5 &&
  g.red.every(isValidChamp) &&

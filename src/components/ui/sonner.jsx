    ...
    (<Sonner
      ...
      toastOptions={{
        classNames: {
          ...
          description: "group-[.toast]:text-slate-300 group-[.toast]:text-[13px] group-[.toast]:font-medium group-[.toast]:tracking-wide group-[.toast]:mt-1",
          title: "group-[.toast]:font-black group-[.toast]:italic group-[.toast]:tracking-tight group-[.toast]:text-base group-[.toast]:text-white",
          ...
          success: "group-[.toast]:border-emerald-500/30 group-[.toast]:bg-emerald-500/10 [&&_svg]:text-emerald-400 shadow-[0_0_20px_rgba(16,185,129,0.1)]",
          error: "group-[.toast]:border-red-500/30 group-[.toast]:bg-red-500/10 [&&_svg]:text-red-400 shadow-[0_0_20px_rgba(239,68,68,0.1)]",
          info: "group-[.toast]:border-blue-500/30 group-[.toast]:bg-blue-500/10 [&&_svg]:text-blue-400 shadow-[0_0_20px_rgba(59,130,246,0.1)]",
          warning: "group-[.toast]:border-amber-500/30 group-[.toast]:bg-amber-500/10 [&&_svg]:text-amber-400 shadow-[0_0_20px_rgba(251,191,36,0.1)]",
        },
      }}
      {...props} />)
  );
